# PIA01_Tarea_hola_mundo
Ejercicio del módulo PIA del curso BDIA.
## Descripción del Proyecto
Este repositorio contiene un ejemplo básico de programación inicial en lenguaje de programación **Python**, un programa de tipo "Hola Mundo".
